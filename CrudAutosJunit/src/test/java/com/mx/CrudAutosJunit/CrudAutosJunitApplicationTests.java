...
class CrudAutosJunitApplicationTests {
	...
	*/	
	...
	public void BuscarId() {
		auto.setId(1);
		Autos emplBuscar = imp.buscar(auto);
		System.out.print("Se encontro" + emplBuscar);
	...
	public void editar() {
		auto.setId(1);
		Autos emplBuscar = imp.buscar(auto);
		System.out.print("Se encontro empleado a editr" + emplBuscar);
		
		emplBuscar.setCilindros(3);
		imp.editar(emplBuscar);
		System.out.println(emplBuscar);
	...
	@Test
	@Order(4)
	public void emininar() {
		auto.setId(1);
		imp.eliminar(auto);
		System.out.print("Se encontro empleado a editr");
